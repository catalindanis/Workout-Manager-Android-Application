...
public class ChestActivity extends AppCompatActivity {
    ...
    private void assignValues(){
        addButton = (Button) findViewById(R.id.addButtonChest);
        myLayout = (LinearLayout) findViewById(R.id.linearLayoutChest);
    }

    private void readFromFile(){
//        try{
//            inputStream = getAssets().open("chest_database.txt");
...
//        }
        try {
            ...
            inputStream = this.openFileInput("chest_database.txt");
...
//                    (this.openFileOutput("chest_database.txt", MODE_PRIVATE));
...
//        }
    ...
    private void emptyFile(){
        try {
            PrintWriter pw = new PrintWriter(this.openFileOutput("chest_database.txt", MODE_PRIVATE));
            pw.print("");
            pw.close();
        }
        catch (IOException e){
