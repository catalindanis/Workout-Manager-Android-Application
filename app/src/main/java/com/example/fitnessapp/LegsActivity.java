...
public class LegsActivity extends AppCompatActivity {
    ...
    private void assignValues(){
        addButton = (Button) findViewById(R.id.addButtonLegs);
        myLayout = (LinearLayout) findViewById(R.id.linearLayoutLegs);
    }

    private void readFromFile(){
//        try{
//            inputStream = getAssets().open("legs_database.txt");
...
//                    (this.openFileOutput("legs_database.txt", MODE_PRIVATE));
...
//        }
    ...
    private void emptyFile(){
        try {
            PrintWriter pw = new PrintWriter(this.openFileOutput("legs_database.txt", MODE_PRIVATE));
            pw.print("");
            pw.close();
        }
        catch (IOException e){
