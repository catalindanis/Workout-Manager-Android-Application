...
public class ShouldersActivity extends AppCompatActivity {
    ...
    private void assignValues(){
        addButton = (Button) findViewById(R.id.addButtonShoulders);
        myLayout = (LinearLayout) findViewById(R.id.linearLayoutShoulders);
    }

    private void readFromFile(){
//        try{
//            inputStream = getAssets().open("shoulders_database.txt");
...
//        }
        try {
            ...
            inputStream = this.openFileInput("shoulders_database.txt");
...
//                    (this.openFileOutput("shoulders_database.txt", MODE_PRIVATE));
...
//        }
    ...
    private void emptyFile(){
        try {
            PrintWriter pw = new PrintWriter(this.openFileOutput("shoulders_database.txt", MODE_PRIVATE));
            pw.print("");
            pw.close();
        }
        catch (IOException e){
