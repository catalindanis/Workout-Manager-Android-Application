...
public class BicepsActivity extends AppCompatActivity {
    ...
    private void assignValues(){
        addButton = (Button) findViewById(R.id.addButtonBiceps);
        myLayout = (LinearLayout) findViewById(R.id.linearLayoutBiceps);
    }

    private void readFromFile(){
//        try{
//            inputStream = getAssets().open("biceps_database.txt");
...
//        }
        try {
            ...
            inputStream = this.openFileInput("biceps_database.txt");
...
//                    (this.openFileOutput("biceps_database.txt", MODE_PRIVATE));
...
//        }
    ...
    private void emptyFile(){
        try {
            PrintWriter pw = new PrintWriter(this.openFileOutput("biceps_database.txt", MODE_PRIVATE));
            pw.print("");
            pw.close();
        }
        catch (IOException e){
